...
#define DESYNCTIMEOUT             (2333*3) // in slots: @15ms per slot -> ~35 seconds. A larger DESYNCTIMEOUT is needed if using a larger KATIMEOUT.
...
enum ieee154e_atomicdurations_enum {
...
#else
   TsTxOffset                =   56,                   //  4000us //Yadhu modified from 131 to 111 to reduce latency,Changed from 111 to 68/68 to 56
   TsLongGT                  =   20,                  //  1300us //Guard time changed to 19 from 20
   ...
   //Measured to be 63 ticks for 47 bytes packet
   wdDataDuration            =  63,                  //  5000us (measured 4280us with max payload), Changed to 100 from 164
#ifdef SLOTDURATION_10MS
