...
#define PORT_TsSlotDuration                 119   // counter counts one extra count, see datasheet,
// execution speed related
//#define PORT_maxTxDataPrepare               45    // 2014us (measured 746us)
//Actual measurement for 47 bytes ws 30 ticks
#define PORT_maxTxDataPrepare               30      //Changed after measurement
#define PORT_maxRxAckPrepare                20    //  305us (measured  83us)
#define PORT_maxRxDataPrepare               23    // 1007us (measured  84us) //Changed to 23 from 33
#define PORT_maxTxAckPrepare                40    //  305us (measured 219us)
// radio speed related, Measured reult matched this value
