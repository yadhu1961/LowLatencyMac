...
//Multiloop modifications start here
...
//   for (running_slotOffset=start_slotOffset;running_slotOffset<start_slotOffset+NUMSERIALRX;running_slotOffset++) {
      ...
      schedule_addActiveSlot(
         2,  // slotOffset number
         CELLTYPE_TXRX,   // TX/RX/TXRX
         TRUE,
         SCHEDULE_MINIMAL_6TISCH_CHANNELOFFSET, // channelOffset number
         &temp_neighbor          // address of the scheduled mote
      );
      schedule_addActiveSlot(
         3,  // slotOffset number
         CELLTYPE_TXRX,   // TX/RX/TXRX
...
#endif
//Multiloop modifications end here
}
...
#if defined(LN1) || defined(LN3)
      memcpy(&my_addr.addr_64b[0],static_schedule_ln1[0].address,8);
      schedule_addActiveSlot(
         static_schedule_ln1[0].slotOffset,  // slotOffset number
         static_schedule_ln1[0].link_type,   // TX/RX/TXRX
         FALSE,
         static_schedule_ln1[0].channelOffset, // channelOffset number
         &my_addr          // address of the scheduled mote
      );
      schedule_addActiveSlot(
         static_schedule_ln1[1].slotOffset,  // slotOffset number
         static_schedule_ln1[1].link_type,   // TX/RX/TXRX
         FALSE,
         static_schedule_ln1[1].channelOffset, // channelOffset number
         &my_addr          // address of the scheduled mote
      );
#endif

#if defined(LN2) || defined(LN4)
      memcpy(&my_addr.addr_64b[0],static_schedule_ln2[0].address,8);
      schedule_addActiveSlot(
         static_schedule_ln2[0].slotOffset,  // slotOffset number
         static_schedule_ln2[0].link_type,   // TX/RX/TXRX
         FALSE,
         static_schedule_ln2[0].channelOffset, // channelOffset number
         &my_addr          // address of the scheduled mote
      );
      schedule_addActiveSlot(
         static_schedule_ln2[1].slotOffset,  // slotOffset number
         static_schedule_ln2[1].link_type,   // TX/RX/TXRX
         FALSE,
         static_schedule_ln2[1].channelOffset, // channelOffset number
         &my_addr          // address of the scheduled mote
      );
#endif
}
