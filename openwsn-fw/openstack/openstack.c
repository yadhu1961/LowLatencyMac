...
//   adaptive_sync_init();
   ...
   boot_message[7] = boot_message[7]+0x30; //Converting to ascii for readability
   openserial_printf("My address",sizeof("My address")-1,'A');
   openserial_printf(boot_message+7,1,'A');
}
